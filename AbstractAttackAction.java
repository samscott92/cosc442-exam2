            ...
            if (te != null) {
                ...
                if (!illuminated) {
                    for (Enumeration<EntityAction> actions = game.getActions(); actions
                            .hasMoreElements();) {
                        EntityAction act = actions.nextElement();
                        if (act instanceof SearchlightAttackAction) {
                            SearchlightAttackAction saa = (SearchlightAttackAction) act;
            ...
            if (night_modifier > 0 && te != null && te instanceof Mech
                ...
                // actions that generate heat give a -1 modifier
                    ...
                    for (Enumeration<EntityAction> actions = game.getActions(); actions
                            .hasMoreElements();) {
                        EntityAction act = actions.nextElement();
                        if (act instanceof WeaponAttackAction) {
                            WeaponAttackAction waa = (WeaponAttackAction) act;
